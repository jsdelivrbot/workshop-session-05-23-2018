...
express()
  ...
  .set('view engine', 'ejs')
  .get('/public/measure-v1', (req, res) => res.sendFile(path.join(__dirname, 'dist/public/measure-v1/index.html')))
  .get('/public/measure-v2', (req, res) => res.sendFile(path.join(__dirname, 'dist/public/measure-v2/index.html')))
